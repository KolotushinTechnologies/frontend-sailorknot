...
export const DashboardUpsertCourseComment: FC<ComponentProps> = ({ title = "Создать комментарий для курса", item }) => {
      ...
      <div className="grid gap-7 lg:grid-cols-2">
        <div className="rounded-2xl bg-lightwhite p-6 dark:bg-white/5">
          ...
          <div className="grid grid-flow-row gap-4">
            ...
            <div className="relative rounded-lg border border-black/10 bg-white px-5 py-4 dark:border-white/10 dark:bg-white/5">
              <label className="mb-1 block text-xs text-black/40 dark:text-white/40">Контент</label>
              <input
                type="text"
        ...
        <div className="rounded-2xl bg-lightwhite p-6 dark:bg-white/5">
          <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
            <h2 className="text-sm font-semibold">Удалить комментарий</h2>
            <button
          ...
          <div className="mb-5 flex items-start gap-1 rounded-lg bg-lightpurple-100/50 p-4 dark:bg-white/5">
            ...
            <div>
              <p className="text-xs">Вы удаляете комментарий</p>
