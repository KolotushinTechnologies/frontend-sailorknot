                ...
                return (
                  <tr
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <div className="mr-2 h-2.5 w-2.5 rounded-full bg-green-500"></div> true
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <Link
                      ...
                      {" | "}
                      <button onClick={onDeleteItem} className="font-medium text-blue-600 hover:underline dark:text-blue-500">Удалить</button>
                    </td>
                  </tr>
                )
              })}
