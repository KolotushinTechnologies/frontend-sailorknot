...
export const DashboardUpsertLesson: FC<ComponentProps> = ({ title = "Создать урок", item }) => {
    ...
    <div className="flex flex-col gap-7">
      ...
      <div className="rounded-2xl bg-lightwhite p-6 dark:bg-white/5">
        <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
          <h2 className="text-sm font-semibold">Удалить урок</h2>
          <button
        ...
        <div className="mb-5 flex items-start gap-1 rounded-lg bg-lightpurple-100/50 p-4 dark:bg-white/5">
          ...
          <div>
            <p className="text-xs">Вы удаляете урок</p>
